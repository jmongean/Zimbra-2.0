#!/bin/sh
##Preparando Variables IP, Hostname para el contenedor
sleep 5
HOSTNAME=$(hostname -a)
DOMAIN=$(hostname -d)
...
## Instalando DNS Server ##
echo "Configurando DNS Server"
...
##Creando Archivo de Configuracion de Zimbra ##
...
EOF
##Instalando Zimbra ##
echo "Descargando Zimbra Collaboration 8.8.7"
